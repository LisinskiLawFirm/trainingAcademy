<template>
  ...
  export default {
    ...
    data: () => ({
      ...
      logoutDialog: false,
      items: [
        { title: 'Phone Operator', icon: 'mdi-phone' },
        { title: 'Intake', icon: 'mdi-sale' },
        { title: 'Sign-Up', icon: 'mdi-content-save' },
        { title: 'Cliente Service Cordinator (CSC)', icon: 'mdi-progress-check' }
      ],
      items2: [
